  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SmartRefresher(
        ...
        enablePullUp: false,
        onLoading: _loading,
        child:userList.isNotEmpty ? SingleChildScrollView(
          child: _isLoad == false ?Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    // width: 40.w,
                                    padding:
                                        EdgeInsets.only(left: 10.w, top: 15),
                                    child:   userList.first.profilePhoto != null || userList.first.profilePhoto != null
                                        ? Container(
                                            height: 70,
                                            width: 70,
                                        ...
                                        : Container(
                                            ...
                                            child: Center(
                                              child: Text(
                                                userList.first.storeName![0].toUpperCase(),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceEvenly,
                                        children: [
                                          if(widget.userIdList.first != Provider.of<Auth>(context, listen: false).userData?['user_id'])
                                          TouchableOpacity(
                                            onTap: () async {
                                              if (!_isFollowing) {
                                                final dynamic response =
                                                await Provider.of<Auth>(context, listen: false)
                                                    .follow(widget.userIdList.first);
                                                if (response['code'] == 200) {
                                                  TOastNotification().showSuccesToast(
                                                      context, response['body']['message']);
                                                  Provider.of<Auth>(context, listen: false)
                                                      .userData?['followings']
                                                      .add({'user_id': widget.userIdList.first});
                                                  setState(() {
                                                    _isFollowing = true;
                                                  });
                                                } else {
                                                ...
                                                final dynamic response =
                                                await Provider.of<Auth>(context, listen: false)
                                                    .unfollow(widget.userIdList.first);
                                                if (response['code'] == 200) {
                                                  TOastNotification().showSuccesToast(
                                                      context, response['body']['message']);
                                                  Provider.of<Auth>(context, listen: false)
                                                      .userData?['followings']
                                                      .removeWhere((element) =>
                                                  element['user_id'] == widget.userIdList.first);
                                                  setState(() {
                                                    _isFollowing = false;
                                                  });
                                                } else {
                                            ...
                                            child: ButtonWidgetHomeScreen(
                                                txt:  _isFollowing ? 'Unfollow' : 'Follow', isActive: true),
                                          ),
                                        ],
                                      ),
                                      Space(3.h),
